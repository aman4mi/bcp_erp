    ...
    <div class="container">
      ...
      <div class="instructions">
        ...
        <table class="table table-bordered">
          <tr>
            <td rowspan="2">Upto 31 March, 2022</td>
            <td>Single Registration</td>
            <td>Tk. 2,000/-</td>
          </tr>
          <tr>
            <td>Registration width spouse</td>
            <td>Tk. 4,000/-</td>
          </tr>
          <tr>
            <td rowspan="2">Upto 30th April, 2022</td>
            <td>Single Registration</td>
            <td>Tk. 4,000/-</td>
          </tr>
          <tr>
        ...
        <div class="text-danger fw-bold">
          <h6>* There will be no registration after 30 th April.</h6>
      ...
      <div class="mt-4">
        ...
        <ul>
          <li>
            ...
            of the following bank in the mentioned account number:
            <ul class="text-info">
              <li>Agrani Bank Limited</li>
              <li>Account No: 0200018199695</li>
            </ul>
          </li>
          <li>After deposition of Registration Fee, the participant needs to scan and upload
            the following document during online registration:
            <ul class="text-info">
              <li>Scanned copy of Bank deposit slip (Width 500 X Height 300) of
